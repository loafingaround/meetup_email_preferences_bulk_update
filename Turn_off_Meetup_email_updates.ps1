...
$updateTypes = @{
  ...
  "event_update" = "ON"  # Changes to event time or location
  "event_comments" = "ON"  # New comments on events you're attending or attended
  "event_reminder" = "NO_RECEIVE"  # Event reminders - possible values: NO_RECEIVE or ROLLUP
  "post_event_rating" = "OFF"  # Event rating requests
  "org_event_broadcast" = "RECEIVE"  # Event updates from organizers
  "photo_upload" = "ON"  # New photos uploaded to event albums
  "photo_comment" = "ON"  # Someone tags or comments on my photo
  "org_broadcast" = "RECEIVE"  # Announcement to members about the group
